    ...
    <tbody class="datatable-body" style="display: table-row-group">
        ...
        <tr class="datatable-row" style="display: table-row">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>
                    <div class="d-flex align-items-center">
                        <a href="{{ route('equipment-categories.edit', $category->id) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
                        ...
                        @if(request()->has('deleted'))
                            ...
                            <form action="{{ route('equipment-categories.restore', $category->id) }}" method="post">
                                @csrf
                        ...
                        @else
                            ...
                            <form action="{{ route('equipment-categories.destroy', $category->id) }}" method="post">
                                @csrf
