<table class="datatable-table" style="display: table">
    ...
    <tbody class="datatable-body" style="display: table-row-group">
        ...
        <tr class="datatable-row" style="display: table-row">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>{{ $challenge->category->name ?? 'Non' }}</span>
            </td>
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>{{ $challenge->equipmentCategory->name ?? 'Non' }}</span>
            </td>
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>
                    <div class="d-flex align-items-center">
                        <a href="{{ route('challenges.edit', $challenge->id) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
                        ...
                        @if(request()->has('deleted'))
                            ...
                            <form action="{{ route('challenges.restore', $challenge->id) }}" method="post">
                                @csrf
