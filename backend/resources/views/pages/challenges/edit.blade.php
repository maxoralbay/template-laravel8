    ...
    <div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
        <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
            ...
            <div class="d-flex align-items-center flex-wrap mr-2">
                <!--begin::Page Title-->
                <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Défi de mise à jour</h5>
                <!--end::Page Title-->
                <!--begin::Actions-->
        ...
        <div class="container">
            ...
            <div class="card card-custom gutter-b example example-compact">
                <div class="card-header">
                    <h3 class="card-title">Défi de mise à jour</h3>
                ...
                <form method="post" action="{{ route('challenges.update', $challenge->id) }}" enctype="multipart/form-data">
                    ...
                    <div class="card-body">
                        <div class="form-group">
                            ...
                            <input type="text" name="title" class="form-control" placeholder="Entrez le titre" value="{{ $challenge->title ?? '' }}" required />
                            @error('title')
                        ...
                        <div class="form-group">
                            ...
                            <span class="text-danger">*</span></label>
                            <input type="text" name="subtitle" class="form-control" placeholder="Entrer le sous-titre" value="{{ $challenge->subtitle ?? '' }}" required />
                            @error('subtitle')
                                <small class="form-text text-danger">{{ $message }}</small>
                            @enderror
                        </div>
                        <div class="form-group">
                            ...
                            <select name="challenge_category_id" class="form-control" id="challengeCategorySelect" required>
                                @foreach ($challengeCategories as $challengeCategory)
                                    @if($challenge->category->id === $challengeCategory->id)
                        ...
                        <div class="form-group">
                            ...
                            <select name="equipment_category_id" class="form-control" id="equipmentCategorySelect">
                                ...
                                @foreach ($equipmentCategories as $equipmentCategory)
                                    @if(isset($challenge->equipmentCategory) && $challenge->equipmentCategory->id === $equipmentCategory->id)
                        ...
                        <div class="form-group">
                            ...
                            <textarea id="challengeContent" name="content" cols="30" rows="10" class="form-control">{!! $challenge->content !!}</textarea>
                        </div>
                    </div>
