<table class="datatable-table" style="display: table">
    ...
    <tbody class="datatable-body" style="display: table-row-group">
        ...
        <tr class="datatable-row" style="display: table-row">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>
                    <div class="d-flex align-items-center">
                        <img src="{{ asset($category->image) }}" style="width: 40px" alt="">
                    </div>
                </span>
            </td>
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>
                    <i class="d-block" style="width: 20px; height: 20px; background-color: {{ $category->color }}"></i>
                </span>
            </td>
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
            ...
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>{{ date('d.m.Y H:i:s', strtotime($category->updated_at)) }}</span>
            </td>
            <td class="datatable-cell-sorted datatable-cell-left datatable-cell">
                <span>
                    <div class="d-flex align-items-center">
                        <a href="{{ route('challenge-categories.edit', $category->id) }}" class="btn btn-sm btn-default btn-text-primary btn-hover-primary btn-icon mr-2">
                        ...
                        @if(request()->has('deleted'))
                            ...
                            <form action="{{ route('challenge-categories.restore', $category->id) }}" method="post">
                                @csrf
                        ...
                        @else
                            ...
                            <form action="{{ route('challenge-categories.destroy', $category->id) }}" method="post">
                                @csrf
