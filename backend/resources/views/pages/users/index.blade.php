            ...
            <div class="card card-custom">
                ...
                <div class="card-header flex-wrap border-0 pt-6 pb-0">
                    <div class="card-title">
                        <h3 class="card-label">Gestion des utilisateurs
                        <span class="d-block text-muted pt-2 font-size-sm">La gestion des utilisateurs simplifiée</span></h3>
                    </div>
                ...
                <div class="card-body">
                    ...
                    {{-- <div class="datatable datatable-bordered datatable-head-custom" id="customDatatable"> --}}
                        @if(isset($users) && $users->count() > 0)
                            ...
                            @component('pages.users.table', ['users' => $users]) @endcomponent
